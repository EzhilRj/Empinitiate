...
public class FileUpload extends Setup {
    ...
    public static String uploadfile(String Path, String excelvalue) throws AWTException, InterruptedException {
        ...
        StringSelection image = new StringSelection(Path + excelvalue);
